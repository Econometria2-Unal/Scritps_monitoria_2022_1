...
monte_carlo = function(rep){
  ...
  for (number in 1:rep){
    ...
    random1 = set_number_dado(runif(10)) # la distribución que se escogió para hacer la simulación fue una distribución uniforme (para garantizar tener un dado justo)
    random2 = set_number_dado(runif(10))
...
# El histograma representa una distribución empírica igualita a la distribución teórica discreta para la suma del resultado de los dos dados
