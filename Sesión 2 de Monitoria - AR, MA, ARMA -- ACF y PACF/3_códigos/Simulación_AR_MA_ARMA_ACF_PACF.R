...
#Graficamos
x11()
autoplot(yt1n, xlab="",ylab="", main=" Simulación de una serie y_t que sigue un PGD ARIMA (1,1,0)",lty=1, lwd=0.4, col="turquoise4") + theme_light()
...
# es estacionario. 
# No obstante, desde ya se les reitera desde ya la importancia de complementar el análisis gráfico de una series de tiempo
...
#Graficamos
x11()
autoplot(yt2n, xlab="",ylab="", main=" Simulación de una serie y_t que sigue un PGD ARIMA (2,1,0)",lty=1, lwd=0.4, col="green4") + theme_light()
...
# Recordad que no solo basta con mirar la gráfica y la ACF de una serie sino
...
#Graficamos
x11()
autoplot(yt3s, xlab="",ylab="", main=" Simulación de una serie y_t que sigue un PGD ARIMA (0,0,1)",lty=1, lwd=0.2, col="turquoise4") + theme_light()
...
#Graficamos
x11()
autoplot(yt3n, xlab="",ylab="", main=" Simulación de una serie y_t que sigue un PGD ARIMA (0,1,1)",lty=1, lwd=0.4, col="turquoise4") + theme_light()
...
#Graficamos
x11()
autoplot(yt5s, xlab="",ylab="", main=" Simulación de una serie y_t que sigue un PGD ARIMA (1,0,1)",lty=1, lwd=0.2, col="turquoise4") + theme_light()
...
#Graficamos
x11()
autoplot(yt5n, xlab="",ylab="", main=" Simulación de una serie y_t que sigue un PGD ARIMA (1,1,1)",lty=1, lwd=0.4, col="green4") + theme_light()
